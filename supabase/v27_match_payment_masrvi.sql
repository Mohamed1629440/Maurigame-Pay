-- =====================================================================
-- KitPay v27 — match_payment_masrvi
-- Matching Masrvi sans merchant_phone : method + amount + client_phone
-- SMS recus de "BMCI" — meme architecture que match_payment_bim
-- =====================================================================
...
SELECT 'v27 match_payment_masrvi created' AS info;
